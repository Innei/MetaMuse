...
>(({ className, ...rest }, forwardedRef) => (
  <ScrollAreaBase.Corner
    {...rest}
    ref={forwardedRef}
    className={clsxm('bg-primary-500', className)}
  />
))
...
>(({ className, ...rest }, forwardedRef) => (
  <ScrollAreaBase.Thumb
    ...
    className={clsxm(
      ...
      'bg-gray-300 hover:bg-primary-400 dark:bg-neutral-500 dark:hover:bg-primary-400',
      'active:bg-primary-500/50 dark:active:bg-primary-400/50',
